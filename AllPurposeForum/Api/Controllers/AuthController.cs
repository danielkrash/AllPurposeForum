...
namespace AllPurposeForum.Api.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<Results<ContentHttpResult, UnauthorizedHttpResult>> ConfirmEmail([FromQuery] string userId, [FromQuery] string? changedEmail)
        {
        ...
        public async Task<Results<Ok , ValidationProblem>> ForgotPassword([FromBody] ForgotPasswordRequest request)
        {
            ...
            if (user == null)
                return Utils.CreateValidationProblem(IdentityResult.Failed(_userManager.ErrorDescriber.InvalidEmail(request.Email)));
