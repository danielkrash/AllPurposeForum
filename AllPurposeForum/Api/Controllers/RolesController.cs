...
namespace AllPurposeForum.Api.Controllers
{
    ...
    public class RolesController : Controller
    {
        ...
        public RolesController(ILogger<RolesController> logger, RoleManager<IdentityRole> roleManager, ApplicationDbContext context)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> RemoveRole(string roleName)
        {
            ...
            return BadRequest($"Failed to remove role '{roleName}': {string.Join(", ", result.Errors.Select(e => e.Description))}");
        }
    }
}
